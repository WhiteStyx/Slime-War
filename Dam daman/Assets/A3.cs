...
public class InteractionController4 : MonoBehaviour
{
    int count = 0;
    ...
    void OnMouseDown()
    {
        ...
        if(Something != null && count > 1)
        {
            ...
            //Something.transform.position = Vector3.MoveTowards(Something.transform.position, Input.mousePosition, speed*Time.deltaTime );
            //LeanTween.move(Something, clickPosition, 0.5f).setEaseSpring();
